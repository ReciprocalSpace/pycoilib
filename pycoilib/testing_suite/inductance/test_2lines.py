...
from scipy.constants import pi as π, mu_0 as μ0
import random
...
def test_mutual_non_coplanar():
    ...
    n_vec = random_vec_on_sphere(100)
...
if __name__ == "__main__":
    test_line_self()
    test_mutual_colinear()
    test_mutual_coplanar()
    test_mutual_non_coplanar()
