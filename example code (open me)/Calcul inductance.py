...
segments.append( pycoil.segment.Arc.from_endpoints(p2, p3, π/2, z) )
segments.append( pycoil.segment.Line(p3, p4) )
segments.append( pycoil.segment.Arc.from_endpoints(p4, p5, π, -z) )
segments.append( pycoil.segment.Line(p5, p6) )
segments.append( pycoil.segment.Arc.from_endpoints(p6, p7, π/2, -z) )
segments.append( pycoil.segment.Line(p7, p8) )
segments.append( pycoil.segment.Arc.from_endpoints(p8, p9, π, z) )

segments.append( pycoil.segment.Line(p0, p1) ) # Amenée de courant
segments.append( pycoil.segment.Line(p9, p10) )
segments.append( pycoil.segment.Line(p10, p11) ) # Sortie de courant
...
segments.append( pycoil.segment.Loop(a, np.array([0.,0.,0.]), axis=z))
segments.append( pycoil.segment.Loop(a, np.array([0.,0.,-b+1e-3]), axis=-z))
segments.append( pycoil.segment.Loop(a, np.array([0.,0.,-b-1e-3]), axis=-z))
segments.append( pycoil.segment.Loop(a, np.array([0.,0.,-2*b]), axis=+z))
